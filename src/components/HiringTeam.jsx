...
const HiringTeam = () => {
    ...
    <nav className=''>
        ...
        <div className="collapsible  mx-4  max-w-[400px] overflow-hidden font-medium   ">
            <label className=''>
                <button onClick={handleclick}> Hiring Team Discussion </button>
                <span className='ml-40'>{arrow?<KeyboardArrowUpIcon/> :<KeyboardArrowDownIcon/> }</span>
            </label>
            <div className="collapsible-text slide-down relative text-center bg-white " id="content">
                {/* <h2>Hiring Team Discussion </h2> */}
                <img src="/images/chat.webp" className="w-[100%] h-[100vh]" alt="" />
                <p className='absolute top-[75%] left-2 text-gray-600 mb-12'> Add your comments/remarks for other team members.</p>
